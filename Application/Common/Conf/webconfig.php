...
//*************************************网站设置****************************************
    ...
    'ADMIN_EMAIL'               =>  'tzbting@163.com',          // 站长邮箱

//*************************************优化推广****************************************
    'WEB_NAME'                  =>  'TZbt博客',             //网站名：
    'WEB_KEYWORDS'              =>  'TZbt,Stb,技术博客,个人博客,tzbtblog',         //网站关键字
    'WEB_DESCRIPTION'           =>  'TZbt的个人技术博客,tzbtblog官方网站',      //网站描述
    'AUTHOR'                    =>  'TZbt',               //默认作者
    'COPYRIGHT_WORD'            =>  '本文为TZbt原创文章,转载无需和我联系,但请注明来自TZbt博客tanzt.cn',       //文章保留版权提示
    'IMAGE_TITLE_ALT_WORD'      =>  'TZbt博客', //图片默认title和alt

//*************************************水印设置****************************************
    'WATER_TYPE'                =>  '1',           //水印类型 0:不使用水印 1:文字水印 2:图片水印 3:文字和图片水印同时使用
    'TEXT_WATER_WORD'           =>  'tanzt.cn',      //文字水印内容
